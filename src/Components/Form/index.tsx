            ...
            render={({ errors, status, touched }) => (
                <Form className='border-2 rounded-xl border-yellow-400 lg:w-fit w-full'>
                    ...
                    <div className="flex flex-row p-4">
                        <button type="submit" className="font-bold !text-white p-2 px-4 rounded-full !bg-white mr-2 !flex">Оформить</button>
                        <button type="reset" className="font-semibold !text-yellow-600 p-2 rounded-full !bg-white mr-2 !flex">Сбросить</button>
                    </div>
                </Form>
            )}
        />
