...
const Nav = ({copyArray, onChange}:any) =>{
    ...
    <div className='inner-nav'>
        <Link to='/' className='flex'>
            <img alt='' src={require('./logo.png')} className='w-12 h-11 mr-4 cursor-pointer flex items-center h-full'></img>
        ...
        <div className='search-border hover:duration-700 hover:border-yellow-400'>
            <div className='rounded-l-lg mr-2 flex items-center pl-2'><img alt='' className='w-5 h-5' src={require('./lupa.png')}></img></div>
                <input 
        ...
        <div className='flex flex-row items-center bg-gray-700 rounded-xl pr-4 ml-4 p-1'>
            <img alt='' className='w-8 h-8 ml-4 mr-2' src={require('./map.png')}></img>
        ...
        <Link to='/cart' className='gradient bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
            <div className='flex flex-row items-center bg-white p-0.5 rounded-full'>
                <img alt='' className="w-11 h-11 cursor-pointer p-2" src='https://cdn-icons-png.flaticon.com/512/6644/6644893.png'></img>
            </div>
        </Link>

        <div className='rounded-full p-0.5 ml-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
            <div className='flex flex-row items-center bg-white p-0.5 rounded-full'>
                <img alt='' src={require('./lk.png')} className='w-11 h-11 cursor-pointer'></img>
            </div>
        </div>
