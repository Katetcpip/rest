        ...
        >
            <div className="min-h-screen flex flex-col">
                ...
                <div className="flex flex-row flex-wrap gap-5 p-4 justify-center w-full mb-4">
                    <Link to="/rest">
                        <div className="w-fit font-semibold bg-slate-100 p-3 rounded-2xl cursor-pointer top-0 px-10 sm:fixed top-28 left-16 right-0 flex items-center gap-2">
                            <ArrowLeftOutlined />
                            Все реcтораны
                        </div>
                    </Link>
                            ...
                            <div className="flex flex-row flex-wrap gap-5 p-4 justify-center lg:w-3/5 sm:w-4/5 w-full mb-8">
                                <div className="flex flex-col rounded-xl w-full">
                                    <div className="flex flex-col items-center w-full h-fit relative">
                                        <img
                                            className="rounded-xl w-full h-72 object-cover z-0"
                                            alt=""
                                        ...
                                        <p className="text-white font-bold sm:text-5xl text-3xl absolute left-4 bottom-20 z-30">
                                            {restaurant.name}
                                        </p>
                                        <div className="flex flex-row gap-2 absolute left-4 bottom-4 z-30">
                                            ...
                                            <div
                                                className="rounded-xl text-slate-800 bg-white p-2 font-semibold opacity-70 hover:scale-105 hover:bg-gray-100 transition hover:duration-700"
                                                onClick={showModal}
                                            >
                                                ❓
                                            </div>
                                            ...
                                            >
                                                <p className="text-slate-800 p-2 border-b text-red-800">
                                                    {restaurant.cuisine.toUpperCase()}
                                                </p>
                                                <p className="text-slate-800 p-2 border-b">
                                                    🕗{' '}
                                                    {dateFormat(
                                                        restaurant.openAt,
                                                        'shortTime'
                                                ...
                                                <p className="text-slate-800 p-2 border-b font-normal">
                                                    ✉️ {restaurant.email}
                                                </p>
                                                <p className="text-slate-800 p-2 border-b font-normal">
                                                    📞 {restaurant.phone}
                                ...
                                <ScrollButton />
                                <div className="pt-10 w-full flex m-auto md:text-4xl text-2xl font-semibold text-gray-800 ">
                                    Для вас
                                </div>
                                <Menu
                                    slug={slug}
